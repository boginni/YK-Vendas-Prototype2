  ...
  Widget getCustomScreen(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: [
          Text('Visitas'),
          FormText(saveFunction: (_){})..title = 'Data Inicial'..mandatoryField = true,
          FormText(saveFunction: (_){})..title = 'Data Final'..mandatoryField = true,
          FormText(saveFunction: (_){})..title = 'Atividade'..mandatoryField = true,
          FormText(saveFunction: (_){})..title = 'Cliente',
          FormText(saveFunction: (_){})..title = 'Observação',
        ],
      ),
    );
  }
